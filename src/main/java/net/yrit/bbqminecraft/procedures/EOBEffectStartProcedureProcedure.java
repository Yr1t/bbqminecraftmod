	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(BbqMinecraftModMobEffects.ESSENCE_OF_BBQ.get())) {
			if (!(((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR)
					.hasModifier((new AttributeModifier(UUID.fromString("c9e9006d-bf60-4e0a-adc2-c96eec26da18"), "BBQ Resistance ", 20, AttributeModifier.Operation.ADDITION)))))
				((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR)
						.addTransientModifier((new AttributeModifier(UUID.fromString("c9e9006d-bf60-4e0a-adc2-c96eec26da18"), "BBQ Resistance ", 20, AttributeModifier.Operation.ADDITION)));
			...
			if (!(((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR_TOUGHNESS)
					.hasModifier((new AttributeModifier(UUID.fromString("75240bdc-0bc8-4d69-b39a-04874a4dc257"), "BBQ Toughness", 10, AttributeModifier.Operation.ADDITION)))))
				((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR_TOUGHNESS)
						.addTransientModifier((new AttributeModifier(UUID.fromString("75240bdc-0bc8-4d69-b39a-04874a4dc257"), "BBQ Toughness", 10, AttributeModifier.Operation.ADDITION)));
